                            ...
                            <div className="space-y-6">
                                ...
                                <div className="border-t border-zinc-800 pt-6 space-y-3">
                                    <div className="flex justify-between text-sm">
                                        ...
                                        <span className="text-white">{formatCurrency(orders?.find(o => o.id === selectedOrderId)?.subtotal || 0)}</span>
                                    </div>
                                    <div className="flex justify-between text-sm">
                                    ...
                                    <div className="flex justify-between text-base font-bold pt-3 border-t border-zinc-800">
                                        ...
                                        <span className="text-white">{formatCurrency(orders?.find(o => o.id === selectedOrderId)?.total_value || 0)}</span>
                                    </div>
                                </div>
                            </div>
                        )}
