...
import { Link2, ExternalLink, TrendingUp, ChevronDown, Clock } from 'lucide-react';
...
export const VisitedLinksTable: React.FC<VisitedLinksTableProps> = ({ links, loading }) => {
  ...
  const displayedLinks = showAll ? links : links.slice(0, INITIAL_ROWS);
  const hasMore = links.length > INITIAL_ROWS;
      ...
      <div className="p-4 bg-gray-50 border-t border-gray-200">
        <div className="flex items-center justify-between text-sm">
          <span className="text-gray-600">
            Showing {displayedLinks.length} of {links.length} pages
          </span>
        ...
        <div className="p-4 border-t border-gray-200 bg-gray-50">
          ...
          >
            {showAll ? (
              ...
              <>
                Show More ({links.length - INITIAL_ROWS} more pages)
