...
export const ShopifyHomeDashboardWidget: React.FC = () => {
  ...
  const { orders, customers, visitedLinks, inventory, loading: tablesLoading } = useDashboardTables();
      ...
      <div className="max-w-7xl mx-auto mb-4">
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <button className="flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 rounded-lg shadow-xs text-sm font-medium text-[#303030] hover:bg-gray-50 transition-colors">
