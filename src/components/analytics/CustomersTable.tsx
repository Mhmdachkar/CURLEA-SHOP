...
export const CustomersTable: React.FC<CustomersTableProps> = ({ customers, loading }) => {
  ...
  const displayedCustomers = showAll ? customers : customers.slice(0, INITIAL_ROWS);
  const hasMore = customers.length > INITIAL_ROWS;
        ...
        <div className="p-4 border-t border-gray-200 bg-gray-50">
          ...
          >
            {showAll ? (
              ...
              <>
                Show More ({customers.length - INITIAL_ROWS} more customers)
