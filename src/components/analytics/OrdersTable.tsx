...
import { ShoppingBag, CheckCircle, Clock, XCircle, ChevronDown } from 'lucide-react';
...
export const OrdersTable: React.FC<OrdersTableProps> = ({ orders, loading }) => {
  ...
  const displayedOrders = showAll ? orders : orders.slice(0, INITIAL_ROWS);
  const hasMore = orders.length > INITIAL_ROWS;
        ...
        <div className="p-4 border-t border-gray-200 bg-gray-50">
          ...
          >
            {showAll ? (
              ...
              <>
                Show More ({orders.length - INITIAL_ROWS} more orders)
