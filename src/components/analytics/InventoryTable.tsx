...
export const InventoryTable: React.FC<InventoryTableProps> = ({ inventory, loading }) => {
  ...
  const displayedInventory = showAll ? inventory : inventory.slice(0, INITIAL_ROWS);
  const hasMore = inventory.length > INITIAL_ROWS;
      ...
      <div className="p-4 bg-gray-50 border-t border-gray-200">
        <div className="flex items-center justify-between text-sm">
          <span className="text-gray-600">
            Showing {displayedInventory.length} of {inventory.length} variants
        ...
        <div className="p-4 border-t border-gray-200 bg-gray-50">
          ...
          >
            {showAll ? (
              ...
              <>
                Show More ({inventory.length - INITIAL_ROWS} more products)
