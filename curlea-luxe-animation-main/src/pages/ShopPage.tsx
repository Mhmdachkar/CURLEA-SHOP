...
const getAllProducts = (): Product[] => {
  ...
  const heatlessProducts: Product[] = [
    ...
    },
    {
      ...
      featured: true,
      description: [
        "Revolutionary heatless styling system for perfect buns and updos",
        "Soft, flexible design molds to your head shape for ultimate comfort",
        "Creates voluminous, long-lasting buns without heat damage",
        "Perfect for overnight styling - wake up with beautiful hair",
        "Suitable for all hair types and lengths",
        "Easy to use - simply wrap, secure, and style",
        "Reusable and easy to clean",
        "Multiple color options available to match your style"
      ],
      ingredients: ["Soft Foam Core", "Stretchy Fabric", "Secure Fasteners"],
          ...
          >
            ...
            <motion.h2
              ...
              <motion.p 
                ...
                transition={{ delay: 1.2, duration: 0.8 }}
              >
                Discover our complete collection of heatless styling tools and hair accessories. 
                From overnight curling rods to elegant hair clips, find everything you need 
                for beautiful, healthy hair styling.
              </motion.p>
            </motion.div>
    ...
    >
        ...
        >
          <div className="absolute inset-0 w-full h-full">
            <motion.img
              ...
              alt={`Curlea Shop Hero ${currentImageIndex + 1}`}
      ...
      >
        ...
        >
          ...
          <HeroTitle text="Discover Your Perfect Collection" />
          
          {/* Subtitle with Character-by-Character Reveal */}
          <HeroSubtitle text="Explore our complete range of heatless styling tools and hair accessories" />
